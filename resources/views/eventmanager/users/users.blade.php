            ...
            <div class="row">
              <div class="col-md-2">
                <input type="hidden" id="setActiveInactiveUrl" url="{{ route('eventmanager.setactiveinactive') }}" />
                  ...
                  <input type="hidden" id="parent_model" value="user_parents" />
              ...
              <div class="col-md-9 text-right"><a class="btn btn-primary icon-btn" href="{{ route('eventmanager.adduser')}}"><i class="fa fa-plus"></i>Add User</a></div>
            </div>
            <div class="clear">&nbsp;</div>
             {{ csrf_field() }}
