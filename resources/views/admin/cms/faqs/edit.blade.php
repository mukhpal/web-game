...
<main class="app-content">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form name="edit_faq_frm" id="edit_faq_frm" method="post" action="{{ route( 'admin.update_faq', [ Hashids::encode( $faq->id ) ] ) }}">
                {{ csrf_field() }}
                <div class="tile">
                    <div class="tile-body">
                        <div class="row mt-3">
                            <div class="col-md-12">
                                ...
                                <div class="form-group {{ $errors->has('question') ? 'has-error' : ''}}">
                                    <input class="form-control" type="text" id="question" value="{{ old( 'question', $faq->question ) }}" placeholder="e.g. How to play?" name="question" required />
                        ...
                        <div class="row mt-3">
                            <div class="col-md-12">
                                ...
                                <div class="form-group {{ $errors->has('answer') ? 'has-error' : ''}}">
                                    <textarea class="form-control" id="answer" placeholder="e.g. Explain Process..." name="answer" required >{{ old( 'answer', $faq->answer ) }}</textarea>
