          ...
          <div class="tile">
            ...
            <div class="row">
              <div class="col-md-2">
                  ...
                  <input type="hidden" id="data_model" value="event_managers" />
              ...
              <div class="col-md-9 text-right"><a class="btn btn-primary icon-btn" href="{{ route('admin.addeventmanager')}}"><i class="fa fa-plus"></i>Add Event Manager</a></div>
            </div>
            <div class="clear">&nbsp;</div>
               {{ csrf_field() }}
               <div class="table-responsive">
              <table class="table table-hover table-bordered" id="eventmanagerTable">
                <thead>
                  <tr>
...
@push('after_scripts')
  ...
  <script type="text/javascript">
      var importantObj = {
          approved_url: '{{ route( 'admin.approve_event_manager' ) }}'
      };
  </script>
  <script src="{{ asset('assets/admin/js/event_manager/index.js') }}"></script>
@endpush