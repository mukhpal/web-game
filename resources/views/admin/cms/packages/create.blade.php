...
<main class="app-content">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form name="add_package_frm" id="add_package_frm" method="post" action="{{ route( 'admin.add_package' ) }}" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="tile">
                    <div class="tile-body">
                        <div class="row mt-3">
                            <div class="col-md-6">
                                ...
                                <div class="form-group {{ $errors->has('name') ? 'has-error' : ''}}">
                                    <input class="form-control" type="text" id="question" value="{{ old( 'name' ) }}" placeholder="Enter Package Name" name="name" />
                                ...
                                <div class="form-group {{ $errors->has('durations') ? 'has-error' : ''}}">
                                    <select class="form-control" id="durations" value="{{ old( 'durations' ) }}" name="durations">
                                        ...
                                        @foreach( $durations as $key => $duration )
                                            <option value="{{$key}}" {{ ( old( 'durations' ) == $key?' selected': '' ) }}>{{$duration}}</option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="row mt-3">
                            <div class="col-md-6">
                                ...
                                <div class="form-group {{ $errors->has('price') ? 'has-error' : ''}}">
                                    <input class="form-control price" type="text" id="price" value="{{ old( 'price' ) }}" placeholder="E.g 10.20" name="price" />
                        ...
                        <div class="row mt-3">
                            <div class="col-md-12">
                                ...
                                <div class="form-group {{ $errors->has('description') ? 'has-error' : ''}}">
                                    <textarea class="form-control" id="description" placeholder="Enter Packager Description" name="description">{{ old( 'description' ) }}</textarea>
...
@push('after_scripts')
  ...
  <script src="{{ asset('assets/admin/js/cms/packages/create.js') }}"></script>
@endpush