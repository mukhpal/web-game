        ...
        <table align="center" border="0" cellpadding="0" cellspacing="0" class="content" style="background-color: #FFFFFF">
          <tr>
            <td id="templateContainerHeader" valign="top" mc:edit="welcomeEdit-01">
              <p style="text-align:center;margin:0;padding:0;"> LOGO <!-- <img src="{{asset('')}}" style="display:inline-block;width:80px;height:auto;"> --></p>
            </td>
          </tr>
              ...
              <table border="0" cellpadding="0" cellspacing="0" class="brdBottomPadd-two" id="templateContainer" width="100%">
                <tr>
                  <td class="bodyContent" valign="top" mc:edit="welcomeEdit-02">
                    ...
                    <h3>Your reset password link is as follow. </h3>

                    <h3><a href="{!! url('/resetPassword', ['token'=>$verification_code]) !!}">Click here</a> to reset your password.</h3>
                    <p>OR</p>
                    <p>Copy & paste the below link in browser.</p>
                    <p><a href="{!! url('/resetPassword', ['token'=>$verification_code]) !!}">{!! url('/resetPassword', ['token'=>$verification_code]) !!}</a></p>
                  </td>
                </tr>
                ...
                <tr align="top">
                  <td class="bodyContentImage" valign="top">
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                      <tr>
                        <td align="left" style="margin:0;padding:0;" valign="top" width="100" mc:edit="welcomeEdit-03">
                          <p>Thanks & Regards<br/>
                           Admin.</p>
                        </td>                        
                      </tr>
              ...
              <table border="0" cellpadding="0" cellspacing="0" id="templateContainerFooter" width="100%">
                <tr>
                  <td valign="top" width="100%" mc:edit="welcomeEdit-11">
                    <h6 style="text-align:center;margin-top: 9px;">Logo</h6>
                    <h6 style="text-align:center;">© 2018 Admin LLC. All Rights Reserved.</h6>
