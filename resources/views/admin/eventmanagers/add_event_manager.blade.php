...
@section('content')
	...
	<main class="app-content">
      ...
      <div class="row">
        <div class="col-md-12">
          <form name="eventmanager_frm" id="add_eventmanager_frm" method="post" action="{{ route('admin.saveeventmanager') }}">
           {{ csrf_field() }}
          <div class="tile">
            ...
            <div class="tile-footer">
              <button class="btn btn-primary" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>Add</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-secondary" href="{{ route('admin.eventmanagerlist') }}"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancel</a>
            </div>
          </div>
