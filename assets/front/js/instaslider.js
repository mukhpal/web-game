        ...
        plugin = {
            ...
            pager: function () {
                ...
                refresh.createPager = function () {
                    ...
                    for (i = 0; i < length; i++) {
                        ...
                        if (settings.gallery === true) {
                            pagers += '<li style="width:100%;' + property + ':' + thumbWidth + 'px;' + gutter + ':' + settings.thumbMargin + 'px"><i class=" fas fa-circle dot_sliders" style="font-size:10px;color:#0a76c5"></i></li>';
                ...
                if (settings.pager) {
                    ...
                    $slide.after('<div style="margin: 0 auto;width:91px; /*margin-left:'+(elSize*2/5)+'px ;*/ overflow:hidden /*background-color:red*/"><ul class="lSPager ' + cl + '"></ul></div>');
